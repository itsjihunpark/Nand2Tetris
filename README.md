...
For the Hardware project I have built a simple instruction set, 16bit, Von Neumann variant hardware platform from elemental logic gate (Nand) defined with Hardware Definition Language (HDL). In addition, an assembler was developed to translate symbolic machine code (assembly) to binary machine code which can be executed on this hardware platform. 
